...
FILESEXTRAPATHS:prepend := "${THISDIR}/linux-tano-at91-4.19/files:"
FILESEXTRAPATHS:prepend := "${THISDIR}/linux-tano-at91-4.19/patches:"
FILESEXTRAPATHS:prepend := "${THISDIR}/linux-tano-at91-4.19/devicetree:"

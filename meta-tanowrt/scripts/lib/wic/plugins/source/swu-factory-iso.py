...
class IsoImagePlugin(SourcePlugin):
    ...
    def do_prepare_partition(cls, part, source_params, creator, cr_workdir,
        ...
        # handle SWU_FACTORY_FILES

        swu_factory_files = get_bitbake_var("SWU_FACTORY_FILES")
        ...
        for deploy_entry in deploy_files:
            ...
            install_cmd = "install -m 644 %s/%s %s/%s " % (deploy_dir, src, isodir, dst)
            exec_cmd(install_cmd)

        # end of handle SWU_FACTORY_FILES

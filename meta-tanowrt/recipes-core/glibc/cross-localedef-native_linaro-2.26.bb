...
FILESEXTRAPATHS =. "${FILE_DIRNAME}/${PN}:${FILE_DIRNAME}/glibc:${FILE_DIRNAME}/glibc-linaro-2.26:"

SRCBRANCH ?= "release/2.26/master"
GLIBC_GIT_URI ?= "git://git.linaro.org/toolchain/glibc.git"
UPSTREAM_CHECK_GITTAGREGEX = "(?P<pver>\d+\.\d+(\.\d+)*)"

SRCREV_glibc ?= "7ab39c6a3cd4a61a2be3d2e6a2a56f4dccca9750"

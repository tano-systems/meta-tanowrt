...
=================================================================
Raspberry Pi Boards Hardware Support Layer (meta-tanowrt-hsl-rpi)
=================================================================

meta-tanowrt-hsl-rpi |mdash| `TanoWrt <https://github.com/tano-systems/meta-tanowrt>`_ hardware support
layer (:term:`HSL`) for the Raspberry Pi boards.
...
Dependencies of the :ref:`meta-tanowrt-hsl-rpi <meta-tanowrt-hsl-rpi>` layer are described in the table below.

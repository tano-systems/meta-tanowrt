...
.. table:: Boardcon EM3566 Features
...
.. _table-boardcon-em3566-supported-targets:
.. table:: Supported Build Targets

   +------------------------------+--------------------------+------------------------+--------------------+
   | Target                       | Machine                  | Running Media          | Installation Media |
   +==============================+==========================+========================+====================+
   | ``boardcon-em3566-sd.yml``   | ``boardcon-em3566-sd``   | microSD card           | |ndash|            |
   +------------------------------+--------------------------+------------------------+--------------------+
   | ``boardcon-em3566-emmc.yml`` | ``boardcon-em3566-emmc`` | internal eMMC          | microSD card       |
   +------------------------------+--------------------------+------------------------+--------------------+
...
- Root Filesystem Image: root file system image recipe name (see :ref:`sec-boardcon-em3566-images` to see supported images).
...
:ref:`table-boardcon-em3566-supported-images`.

.. _table-boardcon-em3566-supported-images:
...
:ref:`table-boardcon-em3566-supported-targets` (Root Filesystem Image column).
...
.. seealso:: 
   ...
   - See :ref:`sec-boardcon-em3566-targets` section to select the required target file.
   - See :ref:`sec-boardcon-em3566-images` section to select the required root filesystem image recipe.
   - See :ref:`sec-boardcon-em3566-artifacts` section for detailed information
...
See :ref:`sec-boardcon-em3566-artifacts` for details.

For example:

.. code-block:: console

   $ sudo dd if=~/tanowrt/build/tanowrt-glibc/deploy/images/boardcon-em3566-sd/tanowrt-image-full-boardcon-em3566-sd.sdcard.img \
             of=/dev/mmcblk1 \
             bs=1k
...
.. note:: To write the factory installation image to an SD card, follow the instructions
          from :ref:`sec-boardcon-em3566-flash-sd` section.
...
.. _sec-boardcon-em3566-access-credentials:
